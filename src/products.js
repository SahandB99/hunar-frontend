export const products = [
  {
    id: 1,
    name: "Trinity Antiques",
    description:
      "Antique 19th Century Roses Painting, Gilt Frame Georgian English Country House Circa 1830",
    price: 425,
    category: "Art",
    imgUrl:
  ...
  {
    id: 2,
    name: "Gallerie Paris Est",
    description:
      "Antique French statue in bronze Diane de Gabies or Artemis by Reduction Sauvage ",
    category: "Sculptor",
    price: 1400,
    imgUrl:
  ...
  {
    id: 3,
    name: "Robert M. Quilter Fine Arts",
    description:
      "Vintage WPA Era American Regional City Scene Oil on Canvas- Pittsburg? ",
